/*
This function is to ensure the email input by user is in the regex format, if not,
show email must be in regex format! message,
*/
...
/*
This function is to ensure the password input by user is in the alphanumeric format,if not,
show the message to user to know which letter they are missing out.
*/
...
/*
 This is the function that ensure the confirm password is the same as the password
 inputed above, if not, show message password must be the same
 */
...
/*
This is the function as when user press register button, it will pop out an alert
saying Register successfully
*/
